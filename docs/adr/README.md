...
| [007](007-filter-threshold-recalibration.md) | Recalibración de thresholds del filtro (Sharpe 0.5→0.3, vol 0.25→0.27) | Propuesto | Evidencia WF vía A (gap HRP−EQ +0.070 único positivo, N=6, 16/16 folds); revierte en 2 líneas |
